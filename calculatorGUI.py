...
btn_percentage = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="%",command=lambda: buttonClick("%"))
btn_percentage.grid(row=5,column=0)

btn_decimal = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text=".",command=lambda: buttonClick("."))
btn_decimal.grid(row=5,column=1)

btn_open = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="(",command=lambda: buttonClick("("))
btn_open.grid(row=5,column=2)

btn_close = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text=")",command=lambda: buttonClick(")"))
